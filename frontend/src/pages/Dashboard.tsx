    ...
    <div className="mx-auto max-w-[1500px] space-y-6 pb-12">
      ...
      {dados && !carregando && (
        <>
          ...
          <section className="grid grid-cols-1 gap-5 xl:grid-cols-2">
            <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-navy-700 dark:bg-navy-800">
              <div className="flex items-center justify-between"><h3 className="text-base font-bold text-slate-900 dark:text-white">Pagamentos com pendências</h3><Link to={`/projeto/${projetoSelecionadoId}`} className="text-xs font-bold text-[#0f9f9a] hover:underline">Revisar projeto</Link></div>
            ...
            <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-navy-700 dark:bg-navy-800">
              <div className="flex items-center justify-between"><h3 className="text-base font-bold text-slate-900 dark:text-white">Últimos lançamentos</h3><Link to={`/projeto/${projetoSelecionadoId}`} className="inline-flex items-center gap-1 text-xs font-bold text-[#0f9f9a] hover:underline">Ver projeto <ArrowUpRight className="h-3.5 w-3.5" /></Link></div>
